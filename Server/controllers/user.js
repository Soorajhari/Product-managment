...
const creatUser = async (req, res) => {
  ...
  const Search=async(req,res)=>{
    ...
    const searchedProducts = await productModel.find({ title: searchPattern }).exec();
...
const getProduct=async (req,res)=>{
 ...
 res.json({status:"ok",data:productData})
  ...
  module.exports={creatUser,addCategory,getCategory,addSubCategory,userLogin,generateAcessToken,getSubCategory,getProduct,
                   Search}