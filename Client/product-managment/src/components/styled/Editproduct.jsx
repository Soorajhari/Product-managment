...
const Editproduct = ({prodata,setModal}) => {
    const initialData = prodata ? { ...prodata } : { title: '', imagePath: [], price: '', total: '', category: '', subcategory: '',description:"",ram:"" };
