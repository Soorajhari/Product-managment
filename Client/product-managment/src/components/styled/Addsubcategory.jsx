    ...
    <div className="flex font-[Ubuntu] justify-center items-center  2xl:min-h-screen">
      <div className="w-[370px] bg-[#EEF0E5]  h-[300px] mt-20 md:mt-10 2xl:mt-0 rounded-2xl shadow-2xl">
        ...
        <div className="flex justify-center">
          <select
            className="mt-6 w-[300px] h-[40px] rounded-lg border border-gray-400"
        ...
        <div className="flex justify-center gap-x-5 mt-6">
          ...
          <button className="p-2 w-[80px] bg-gray-400 rounded-2xl" onClick={(e)=>handleClose(e)}>
            Discard  
          </button>
        </div>
      </div>
